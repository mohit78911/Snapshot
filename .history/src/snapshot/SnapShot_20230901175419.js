    ...
    <Box>
      ...
      <div className="container">
        ...
        <div >
          ...
          >
            <DialogTitle sx={{background:"red"}} id="alert-dialog-title">
              {"Please Fill Search Box"}
            
            </DialogTitle>
            <DialogContent sx={{background:"red"}}>
              <DialogContentText id="alert-dialog-description">
                Without any data we can't search anything or not showing any
                pictures.
              </DialogContentText>
            </DialogContent>
            <DialogActions sx={{background:"rgb(255, 255, 255,0.4)"}}>
